<template>
    <div>
        <div class="container-fluid">
            ...
            <div class="barang-box mb-3 bg-light rounded-top" v-if="barang">
                <div class="row">
            ...
            <div class="barang-box bg-light rounded-top" v-if="barang.status">
                <div class="row">
                        <div class="col-md-4 mb-3" v-for="status of barang.status" :key="status.id">
                            ...
                            <InputNumber class="w-100" id="withoutgrouping" v-on:keyup.enter="updateStok(status.id, status.stok)" v-model="status.stok" mode="decimal" :placeholder="'Stok '+status.status+' Lab '+status.location" :useGrouping="false" />
                        </div>
                </div>
            </div>
        </div>
